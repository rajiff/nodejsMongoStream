...
/* Template for generating data on https://www.json-generator.com */
/*[
  '{{repeat(1000000, 7)}}',
  {
    name: '{{firstName()}}',
    ...
    vendor: '{{company()}}',
  sku: '{{lorem(1, "words").toUpperCase()+integer(0, 10)}}',
  price: '{{floating(1000, 4000, 2, "00")}}',
  quantity: '{{integer(2, 300)}}',
  addedBy: 'system',
    tags: [ '{{repeat(3)}}', '{{lorem(1, "words").toLowerCase()}}']
  }
]*/
